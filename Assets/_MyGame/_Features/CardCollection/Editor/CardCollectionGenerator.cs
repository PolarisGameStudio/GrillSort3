    ...
    public class CardCollectionGenerator : EditorWindow
    {
        ...
        private void GenerateAlbums()
        {
            ...
            for (int i = 0; i < albumCount; i++)
            {
                ...
                {
                    var album = ScriptableObject.CreateInstance<AlbumConfigSO>();
        ...
        private void GenerateCards(int idAlbum, AlbumConfigSO album)
        {
            ...
            for (int i = 0; i < cardCountInAlbum; i++)
            {
                ...
                if (!File.Exists(fullPath))
                {
                    var card = ScriptableObject.CreateInstance<CardConfigSO>();
