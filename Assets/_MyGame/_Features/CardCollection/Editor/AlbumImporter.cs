...
namespace MyGame.Modules.CardCollection
{
    ...
    {
        [SerializeField] private List<AlbumConfigSO> albumConfigs = new List<AlbumConfigSO>();
        [SerializeField] private List<CardConfigSO> cardConfigs = new List<CardConfigSO>();
