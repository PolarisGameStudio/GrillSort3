...
public class UICurrencyEnergyInGame : MonoBehaviour
{
    ...
    private async UniTask CollectEffect(GameResource resource, Action onComplete = null)
    {
        ...
        // txtValue.DOCounter(0, diff, duration);
        // transform.DOShakePosition(durationShake, strengthShake, vibratoShake, randomnessShake, snappingShake, fadeOutShake, ShakeRandomnessMode.Full);
