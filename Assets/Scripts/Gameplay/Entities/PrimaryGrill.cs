...
namespace Gameplay.Entities
{
    public class PrimaryGrill : GrillBase
    {
        ...
        protected virtual void OnComplete()
        {
            ...
            // GameplayController.instance.CollectItem(id, container.position);
            isProcess = true;
        ...
        public virtual bool CanShuffle()
        {
            ...
            foreach (var slot in slots)
            {
                ...
                if (item != null && item.Data != null)
                {
                    if (item.itemType is ItemType.Ice or ItemType.Bomb or ItemType.Key or ItemType.Key2) return false;
                }
            }
