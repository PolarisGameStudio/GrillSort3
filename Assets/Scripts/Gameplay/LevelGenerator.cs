...
// #if UNITY_ANDROID
//             if (level is >= 6 and <= 100 && grillData.grillType == GrillType.Lock)
//             {
...
//         if (questEventService.IsUnlocked() == false || questEventService.CheckCompleteAllQuest()) return;
...
//     private void GenerateBonusCoinManager()
//     {
//         if (CheckModeBonusCoin())
//             bonusCoinManager = GameFactory.CreateEntity<BonusCoinManager>("BonusCoinManager", gameplaySpace);
//     }

//     public bool CheckModeBonusCoin()
//     {
//         return true;
//     }
...
//                         else if (layerData.itemData[i].id > MAXITEMS && layerData.itemData[i].itemType == ItemType.Coin)
//                         {
//                             idsTrueInLevel.Add(layerData.itemData[i].id);
//                         }
//                         else if (layerData.itemData[i].id > MAXITEMS && !idsFalseInLevel.Contains(layerData.itemData[i].id))
//                         {
...
//                         if (layerData.itemData[i].id == (int)ItemId.Item_Special_Coin_1)
//                         {
//                             (layerData.itemData[i] as ItemCoinData).coin = 3;
//                         }
//                         else if (layerData.itemData[i].id == (int)ItemId.Item_Special_Coin_2)
//                         {
//                             (layerData.itemData[i] as ItemCoinData).coin = 5;
//                         }
//                     }
//                 }
//             }
...
//                 foreach (var itemData in layerData.itemData)
//                 {
//                     if (itemData != null && itemData.id > MAXITEMS)
//                     {
...
//         if (bonusCoinManager != null)
//         {
//             GameFactory.ReturnEntity(bonusCoinManager);
//         }
//     }
...
//         List<ShuffleLayerData> primaryShuffleCanNotShuffle = new();
...
//                 {
//                     primaryShuffleCanNotShuffle.Add(primaryShuffleLayer);
//                 }
//                 else
//                 {
...
//                 if (r == 0 && primaryIds.Count < primarySlot - 3)
//                 {
...
//         {
//             primaryIds.AddRange(subIds.GetRange(0, subIds.Count - subSlot));
...
//         GameplayController.instance.CollectItem(itemId, Vector3.zero);
//         await UniTask.Delay(500);
//     }

//     public Dictionary<int, int> GetItemsWithLayer()
//     {
...
//                 {
//                     if (idCount[itemData.id] < layer)
//                         idCount[itemData.id] = layer;
//                 }
//             }
...
//                 {
//                     if (itemData is not { id: > 0 }) continue;
//                     if (!idCount.TryAdd(itemData.id, layer))
//                     {
//                         if (idCount[itemData.id] < layer)
//                             idCount[itemData.id] = layer;
//                     }
...
//         if (obstacle.ObstacleType is not ObstacleType.LockAreaHorizontal and ObstacleType.LockAreaVertical) return;
//         isUseBooster = true;
//         MySonatFramework.GetService<BoosterService>().UseBoosterSuccess(GameResource.BoosterMagicKey);
...
//     {
//         return grill.grillType is GrillType.Ice && grill.IsLock;
//     }
...
//                     return;
//                 case PrimaryGrill { grillType: GrillType.Ice } grill:
